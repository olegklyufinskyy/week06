...
describe('Week 6 Lab Tests:', () => {
  ...
  describe('Question 1a: Sorted array of number', () => {
    it ('#Should sort an array in ascending order', () => {
      let arrayOfNumber = [1, 5, 3, 2, 4]
      arrayOfNumber = arrayOfNumber.sort((a, b) => a -b)

      expect(arrayOfNumber).to.deep.equal([1,2,3,4,5])
...
describe('Question 1b: Manage my wallet', () => {
  ...
  it('#Should be to remove money from my wallet', () => {
    let myWallet = new Wallet (10)
...
describe('Question 1c: Day of Week',() => {
  ...
  it('#Should return Manday with input 1',() => {
 ...
 describe('#Question 1d: Only wizards should pass', function(){
  ...
  it('#Should return an array of objects... objects.isWizzard should be true', () => {

    expect(onlyWizards(movieCharacters)).to.deep.equel([
      {
        name: 'Kalcifer',
        isAWizard: false,
        quote: `I don't cook! I'm a scary and powerful fire demon!`,
